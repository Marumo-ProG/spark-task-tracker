        ...
        <Stack padding={2} sx={{backgroundColor: Colors.lightGrey, borderRadius: "8px", minHeight: "400px"}}>
            <Stack direction="row" alignItems={"center"} justifyContent="space-between" maxHeight="56px">
                ...
                <Stack direction={"row"} spacing={1} alignItems="center">
                    <IconButton sx={{ backgroundColor: Colors.medGrey, color: Colors.black }} aria-label="add task">
                        <AddRoundedIcon sx={{fontSize: 15}}/>
                    </IconButton>
                    <IconButton sx={{ backgroundColor: Colors.medGrey, color: Colors.black }} aria-label="menu">
